...
files = [
    ...
    (os.path.join("wine_quality", "configuration.py"), absolute_imports),
    (os.path.join("wine_quality", "data_ingestion.py"), absolute_imports),
    (os.path.join("wine_quality", "data_validation.py"), absolute_imports),
    (os.path.join("wine_quality", "data_transformation.py"), absolute_imports),
    (os.path.join("wine_quality", "model_trainer.py"), absolute_imports),
    (os.path.join("wine_quality", "model_evaluation.py"), absolute_imports),
